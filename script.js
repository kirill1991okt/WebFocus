$('.first__screen .owl-carousel').owlCarousel({
    loop:true,
    items: 1,
    nav: true,
...
$('.main__direction-courusel .owl-carousel').owlCarousel({
    ...
    items: 1,
    nav: true,
    navText: ['<img src="./assets/chevron-left.png" class="main__direction-btn main__direction-prev">','<img src="./assets/chevron-right.png"  class="main__direction-btn main__direction-next">'],
    dots: false,
})
